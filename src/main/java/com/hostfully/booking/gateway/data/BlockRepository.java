...
public interface BlockRepository extends JpaRepository<BlockModel, Long> {
    ...
    @Query("SELECT count(1) FROM BlockModel b WHERE b.property.id = :propertyId AND b.startDate BETWEEN :startDate and :finalDate OR b.finalDate BETWEEN :startDate and :finalDate")
